...
const CategoryPage = ({ params }) => {
  // Extract category from slug parameter
  const slug = params.slug || [];
  const categoryFromSlug = slug.length > 0 ? slug[0] : null;
  const decodedCategory = categoryFromSlug
    ? decodeURIComponent(categoryFromSlug.replace(/-/g, " "))
    : null;
  ...
  const subcategories = {
    ...
    Proteins: ["Whey", "Plant Based", "Egg", "Blend"],
    "Pre Workouts": ["Stimulant", "Non-Stimulant", "Energy", "Focus"],
    Creatine: ["Monohydrate", "HCL", "Ethyl Ester", "Blend"],
    "Mass Gainers": ["High Calorie", "Lean Mass", "Weight Gainer"],
    BCAAs: ["2:1:1", "4:1:1", "Intra-Workout", "Recovery"],
  };
  ...
  // ADD THESE VARIANTS - this was the missing code
                    ...
                    >
                      <Link href={`/product/${product.id}`}>
                        ...
                        <div className="p-4">
                          ...
                          <button className="w-full bg-black text-white py-2 rounded-md hover:bg-blue-900 transition-colors">
                            Add to Cart
                          </button>
                        </div>
                      </Link>
