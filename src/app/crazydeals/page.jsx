...
export default function CrazyDeals() {
  const deals = [
    ...
    },
    {
      ...
      title: "BUY ANY 3",
      price: "₹1999",
      subtitle: "CHOOSE FROM 40+ FITNESS AND WELLNESS PRODUCTS",
      image: "/images/deals/deal-1999.jpg",
      link: "/products/deals/1999",
      savings: "Save 20%",
    },
    {
      id: 5,
      title: "BUY 3 @",
      price: "₹5499",
      subtitle: "CHOOSE FROM 20+ FITNESS & WELLNESS PRODUCTS",
      image: "/images/deals/deal-5499.jpg",
      link: "/products/deals/5499",
      savings: "Save 40%",
      tag: "Limited Time",
    },
  ];
    ...
    <div className="w-full bg-gradient-to-b from-gray-50 to-white py-12">
      <div className="container mx-auto px-4">
        <div className="flex flex-col items-center mb-10 text-center">
          ...
          <h2 className="text-3xl md:text-4xl font-bold mb-3">Crazy Deals</h2>
          <p className="text-gray-600 max-w-2xl">
            Mix and match from our wide selection of fitness and wellness
            products to create your perfect bundle at unbeatable prices.
          </p>
        </div>
            ...
            >
              ...
              <div className="relative h-48 sm:h-56 w-full overflow-hidden">
                ...
                <div className="absolute top-4 left-4 z-20">
                  <div className="bg-red-600 text-white font-medium text-xs px-3 py-1 rounded-full">
                    {deal.savings}
                  </div>
                </div>
              </div>
              ...
              <div className="p-5 flex flex-col flex-grow">
                ...
                <div className="mt-auto flex items-center text-blue-600 font-medium group-hover:text-blue-800">
                  <span>View Deal</span>
                  <ArrowRight
                    size={16}
        ...
        <div className="flex justify-center">
          <Link
            href="/products"
            className="bg-gradient-to-r from-red-600 to-red-700 hover:from-red-700 hover:to-red-800 text-white font-bold py-3 px-8 rounded-full transition-all duration-300 hover:shadow-lg flex items-center gap-2"
          >
